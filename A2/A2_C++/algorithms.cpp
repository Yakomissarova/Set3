...
void SortingAlgorithms::mergeSort(std::vector<int>& arr, int left, int right) {
    if (left < right) {
...
void SortingAlgorithms::mergeInsertionSort(std::vector<int>& arr, int left, int right, int threshold) {
    if (left < right) {
